...
func buildRecallEndpointCatalog() []RecallEndpointDoc {
	return []RecallEndpointDoc{
		{Category: "Bots", Name: "Create Bot", Description: "Cria bot ad-hoc ou agendado, com meeting_url, join_at, transcription e output_media.", Official: "POST /api/v1/bot/", Local: "POST /api/review/recall/bots", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "bot", Presentation: "Form de criacao com exemplos para bot gravador e AI agent."},
		{Category: "Bots", Name: "List Bots", Description: "Lista bots para acompanhar status, meeting_url, metadata e links para recordings.", Official: "GET /api/v1/bot/", Local: "GET /api/review/recall/bots", DocsURL: "https://docs.recall.ai/v1.10/reference/bot_list", Resource: "bot", Presentation: "Tabela principal da review com filtros simples."},
		{Category: "Bots", Name: "Retrieve Bot", Description: "Consulta um bot especifico e o estado atual na reuniao.", Official: "GET /api/v1/bot/{bot_id}/", Local: "GET /api/review/recall/bots/{bot_id}", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "bot", Presentation: "Painel de detalhe do bot selecionado."},
		{Category: "Bots", Name: "Update Bot", Description: "Atualiza meeting_url, metadata, join_at e configuracoes mutaveis.", Official: "PATCH /api/v1/bot/{bot_id}/", Local: "PATCH /api/review/recall/bots/{bot_id}", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "bot", Presentation: "Acao de editar dados sem recriar o recurso."},
		{Category: "Bots", Name: "Delete Bot", Description: "Encerra/remocao do bot no ambiente de demo.", Official: "DELETE /api/v1/bot/{bot_id}/", Local: "DELETE /api/review/recall/bots/{bot_id}", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "bot", Presentation: "Limpeza de recursos e reset de fluxo."},
		{Category: "Recording", Name: "Start Recording", Description: "Inicia gravacao sob demanda para um bot ja conectado.", Official: "POST /api/v1/bot/{bot_id}/start_recording/", Local: "POST /api/review/recall/bots/{bot_id}/start_recording", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "recording", Presentation: "Botao para simular gravacao manual."},
		{Category: "Recording", Name: "Pause Recording", Description: "Pausa captura de midia em uma gravacao em andamento.", Official: "POST /api/v1/bot/{bot_id}/pause_recording/", Local: "POST /api/review/recall/bots/{bot_id}/pause_recording", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "recording", Presentation: "Mostra diferenca entre status do bot e da gravacao."},
		...
		{Category: "Recording", Name: "Stop Recording", Description: "Finaliza a gravacao e expõe media_shortcuts.", Official: "POST /api/v1/bot/{bot_id}/stop_recording/", Local: "POST /api/review/recall/bots/{bot_id}/stop_recording", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "recording", Presentation: "Gera transcript, mixed video, audio, metadata e participant events."},
		{Category: "Bots", Name: "Leave Call", Description: "Faz o bot sair da chamada; em demo tambem conclui gravacao ativa.", Official: "POST /api/v1/bot/{bot_id}/leave_call/", Local: "POST /api/review/recall/bots/{bot_id}/leave", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "bot", Presentation: "Encerramento limpo da sessao."},
		{Category: "Output Media", Name: "Configure Output Media", Description: "Apresenta configuracao de camera/screen share/webpage para AI agents.", Official: "Campo output_media em Create/Update Bot", Local: "POST /api/review/recall/bots/{bot_id}/output_media", DocsURL: "https://docs.recall.ai/v1.10/docs/stream-media", Resource: "output_media", Presentation: "Explica bots que escutam e respondem na reuniao."},
		{Category: "Recording", Name: "List Recordings", Description: "Lista gravacoes geradas pelos bots e respectivos artefatos.", Official: "GET /api/v1/recording/", Local: "GET /api/review/recall/recordings", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "recording", Presentation: "Tabela de gravacoes e status."},
		{Category: "Recording", Name: "Retrieve Recording", Description: "Detalhe completo da gravacao com media_shortcuts.", Official: "GET /api/v1/recording/{recording_id}/", Local: "GET /api/review/recall/recordings/{recording_id}", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "recording", Presentation: "Card expandido para inspeção de artefatos."},
		{Category: "Media", Name: "Retrieve Transcript", Description: "Consulta transcript assincrono ou disponibilizado via media object.", Official: "GET /api/v1/transcript/{transcript_id}/", Local: "GET /api/review/recall/transcripts/{transcript_id}", DocsURL: "https://docs.recall.ai/docs/async-transcription", Resource: "transcript", Presentation: "Preview do transcript na UI."},
		{Category: "Media", Name: "Retrieve Video Mixed", Description: "Acessa video MP4 consolidado da reuniao.", Official: "GET /api/v1/video_mixed/{video_id}/", Local: "GET /api/review/recall/video_mixed/{video_id}", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "video_mixed", Presentation: "Link para arquivo servido localmente."},
		{Category: "Media", Name: "Retrieve Audio Mixed", Description: "Acessa audio consolidado da reuniao.", Official: "GET /api/v1/audio_mixed/{audio_id}/", Local: "GET /api/review/recall/audio_mixed/{audio_id}", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "audio_mixed", Presentation: "Complementa cenarios audio-only."},
		{Category: "Media", Name: "Retrieve Meeting Metadata", Description: "Recupera metadata estrutural da reuniao.", Official: "GET /api/v1/meeting_metadata/{metadata_id}/", Local: "GET /api/review/recall/meeting_metadata/{metadata_id}", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "meeting_metadata", Presentation: "Mostra participantes, plataforma e duracao."},
		{Category: "Media", Name: "Retrieve Participant Events", Description: "Recupera joins/leaves/mutes ao longo da reuniao.", Official: "GET /api/v1/participant_events/{event_id}/", Local: "GET /api/review/recall/participant_events/{event_id}", DocsURL: "https://docs.recall.ai/docs/media-shortcuts", Resource: "participant_events", Presentation: "Timeline util para QA e auditoria."},
		{Category: "Calendar", Name: "Create Calendar Meeting", Description: "Prepara reuniao de calendario para ligacao automatica do bot.", Official: "POST /api/v1/calendar/meeting/", Local: "POST /api/review/recall/calendar/meetings", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "calendar_meeting", Presentation: "Cobre fluxo pre-call."},
		{Category: "Calendar", Name: "List Calendar Meetings", Description: "Lista reunioes monitoradas via calendario.", Official: "GET /api/v1/calendar/meeting/", Local: "GET /api/review/recall/calendar/meetings", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "calendar_meeting", Presentation: "Tabela com starts_at e estado de gravacao."},
		{Category: "Calendar", Name: "Retrieve/Update Calendar Meeting", Description: "Permite consultar e ajustar estado/metadados da reuniao de calendario.", Official: "GET|PUT /api/v1/calendar/meeting/{meeting_id}/", Local: "GET|PUT /api/review/recall/calendar/meetings/{meeting_id}", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "calendar_meeting", Presentation: "Mostra associacao entre agenda e bot."},
		{Category: "Calendar", Name: "Refresh Calendar", Description: "Forca sincronizacao do calendario para puxar reunioes futuras.", Official: "POST /api/v1/calendar/meeting/refresh/", Local: "POST /api/review/recall/calendar/meetings/refresh", DocsURL: "https://docs.recall.ai/docs/bot-overview", Resource: "calendar_meeting", Presentation: "Acao administrativa de sync."},
		{Category: "Webhooks", Name: "Webhook Samples", Description: "Exibe exemplos de eventos bot.joined, recording.started, recording.done e bot.left.", Official: "Webhook events", Local: "GET /api/review/recall/webhooks/samples", DocsURL: "https://docs.recall.ai/docs/getting-started?utm_source=Recall.ai&utm_medium=navbar&utm_content=API_Docs", Resource: "webhook", Presentation: "Usado no review para explicar callbacks."},
	}
}
...
func (s *RecallReviewService) materializeMediaLocked(rec *RecallReviewRecording) map[string]RecallMediaObject {
	...
	eventsBody := map[string]any{
		"events": []map[string]any{
			{"type": "participant_joined", "at_sec": 0, "participant": "Mateus"},
			{"type": "participant_joined", "at_sec": 1, "participant": "Ana"},
			{"type": "participant_left", "at_sec": rec.DurationSec, "participant": "Ana"},
		},
	}
